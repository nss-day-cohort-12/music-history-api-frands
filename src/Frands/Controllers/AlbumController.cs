...
namespace Frands.Controllers
{
    ...
    public class AlbumController : Controller
    {
        ...
        public AlbumController(FrandsDbContext context)
        {
            _context = context;
        }
        ...
        // GET: api/values
        [HttpGet]
        public IActionResult Get([FromQuery] int albumId)
        {
            ...
            IQueryable<Album> albums = from record in _context.Album
                                       select new Album
                                       {
                                           ...
                                           AlbumsHref = String.Format("/api/Album?AlbumId={0}", record.AlbumId)
                                       };

            if (albums != null)
            {
                albums = albums.Where(g => g.AlbumId == albumId);
            }
